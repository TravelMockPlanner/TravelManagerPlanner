...
class RestaurantViewCell: UITableViewCell {
    ...
    lazy var sIdx: Int = 0
    var destinationData: DestiSearchResponseData!
    ...
    lazy var restaurantImg: UIImageView = {
        ...
        func restaurantSelectAction() {
            cellDelegate?.categoryButtonTapped(title: restaurantTitle.text ?? "", place: self.place, sIdx: self.sIdx, destData: destinationData)
        }
